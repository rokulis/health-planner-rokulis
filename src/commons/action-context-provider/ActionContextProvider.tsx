...
import { ViewPatientTreatmentPlan } from '@/features/patients/patient-view/treatment-plans/view/ViewPatientTreatmentPlan';
...
const ACTIONS = {
  ...
  plan_next_cycle: (params?: Record<string, any>) => (
    <Drawer title="Plan Next Cycle" isOpen={true}>
      <PlanNextCycle treatmentPlanId={params?.id} />
    </Drawer>
  ),
